...
<div id="top-bar">
    <div id="top-left">
        <a href="index.html"><img src="images/oshamfashion.png" width="200" height="50"></a>
    </div>
    <div id="top-right">
        <ul>
            <li>
...
<div id="dimension">
    <div id="principal">
        ...
        <div id="input">
            <form enctype="multipart/form-data" action="../Controller/postCoverPicture.php" method="post">
                <br/><br/>
